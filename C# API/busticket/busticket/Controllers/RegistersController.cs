...
namespace busticket.Controllers
{
    ...
    public class RegistersController : ControllerBase
    {
        ...
        public RegistersController(BusContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Register>> PostRegister(Register register)
        {
          if (_context.Registers == null)
          {
              return Problem("Entity set 'BusContext.Registers'  is null.");
          }
        ...
        {
            return (_context.Registers?.Any(e => e.UserId == id)).GetValueOrDefault();
        }
    }
}
