...
namespace Basic
{
    public class BankTransactions
    {
        ...
        public BankTransactions(int custid, 
            long accno, string accname, 
            decimal balance) 
        {
            this.Custid = custid;
            this.Accno = accno; 
        ...
        public int Custid { get => custid; 
            set => custid = value; }
        public long Accno { get => accno; 
            set => accno = value; }
        public string Accname { get => accname; 
            set => accname = value; }
        public string Status { get => status; 
            set => status = value; }
        public decimal Balance { get => balance; 
            set => balance = value; }
        public decimal Creditamt { get => creditamt;
            set => creditamt = value; }
        public decimal Debitamt { get => debitamt;
            set => debitamt = value; }
